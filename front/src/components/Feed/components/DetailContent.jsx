  ...
  return (
    <>
      <div className="detail_box">
        ...
        <div className="mt-4">
          <div className="detail_title">{feed.content}</div>
                  ...
                  {voteCompleted ? (
                    <>
                      <div onClick={count(countAll)}>
                        <div className="detail_close_button" onClick={onClose}>
                          닫기
                        </div>
                      </div>
                    </>
                    ...
                    <>
                      <div onClick={amend}>
                        <div className="detail_button" onClick={postVote}>
                          선택완료
                        </div>
                      </div>
                    </>
            ...
            {feed.type === 2 && (
              <>
                <div className="container mt-3">
                  <div
                    className={
                      voteSelected === 0 ? 'detail_vs active' : 'detail_vs'
                    }
                    onClick={() => {
                      if (!voteCompleted) {
                        setVoteSelected(0);
                  ...
                  <div
                    className={
                      voteSelected === 1 ? 'detail_vs active' : 'detail_vs'
                    }
                    onClick={() => {
                      if (!voteCompleted) {
                        setVoteSelected(1);
              ...
              <>
                <div>
                  <div className="container mt-3 ox_container">
                    <div
                      className={
                        voteSelected === 0 ? 'detail_ox active' : 'detail_ox'
                      }
                      onClick={() => {
                        if (!voteCompleted) {
                          setVoteSelected(0);
                    ...
                    <div
                      className={
                        voteSelected === 1 ? 'detail_ox active' : 'detail_ox'
                      }
                      onClick={() => {
                        if (!voteCompleted) {
                          setVoteSelected(1);
